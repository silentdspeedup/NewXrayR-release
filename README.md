...
Find the source code here: [silentdspeedup/NewXrayR](https://github.com/silentdspeedup/NewXrayR)
...
## Docker compose升级 (已禁用)
<!-- Docker Compose升级功能已注释
